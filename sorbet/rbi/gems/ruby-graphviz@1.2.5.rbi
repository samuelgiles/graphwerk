...
class GraphViz
  ...
  # @raise [ArgumentError]
  #
  # source://ruby-graphviz//lib/graphviz.rb#682
  def -(oNode); end
  ...
  # @raise [ArgumentError]
  #
  # source://ruby-graphviz//lib/graphviz.rb#681
  def >(oNode); end
  ...
  # @raise [ArgumentError]
  #
  # source://ruby-graphviz//lib/graphviz.rb#683
  def >>(oNode); end
  ...
  # This accessor allow you to set global edges attributes
  #
  # source://ruby-graphviz//lib/graphviz.rb#80
  def edge_attrs; end
  ...
  # This accessor allow you to set global graph attributes
  #
  # source://ruby-graphviz//lib/graphviz.rb#72
  def graph_attrs; end
  ...
  # Get the graph name
  #
  # source://ruby-graphviz//lib/graphviz.rb#665
  def id; end
  ...
  # This accessor allow you to set global nodes attributes
  #
  # source://ruby-graphviz//lib/graphviz.rb#76
  def node_attrs; end
  ...
  #   * 2 = none
  #
  # source://ruby-graphviz//lib/graphviz.rb#625
  ...
  # * hOpts : Graph attributes
  #
  # source://ruby-graphviz//lib/graphviz.rb#304
...
class GraphViz::DOTScript
  ...
  # source://ruby-graphviz//lib/graphviz/dot_script.rb#62
  def <<(line); end
  ...
  # source://ruby-graphviz//lib/graphviz/dot_script.rb#51
  ...
  # source://ruby-graphviz//lib/graphviz/dot_script.rb#96
  def to_s; end
...
class GraphViz::DOTScriptData
  ...
  # source://ruby-graphviz//lib/graphviz/dot_script.rb#15
  def <<(data); end
  ...
  # source://ruby-graphviz//lib/graphviz/dot_script.rb#30
  def to_s; end
...
class GraphViz::Edge
  ...
  # source://ruby-graphviz//lib/graphviz/edge.rb#123
  def -(node); end

  # source://ruby-graphviz//lib/graphviz/edge.rb#117
  def <<(node); end

  # source://ruby-graphviz//lib/graphviz/edge.rb#122
  def >(node); end

  # source://ruby-graphviz//lib/graphviz/edge.rb#124
  def >>(node); end
  ...
  #
  # source://ruby-graphviz//lib/graphviz/edge.rb#64
  ...
  # Return the node one as string (so with port if any)
  #
  # source://ruby-graphviz//lib/graphviz/edge.rb#54
...
class GraphViz::Node
  ...
  #
  # source://ruby-graphviz//lib/graphviz/node.rb#107
  def -(node); end
  ...
  # Create an edge between the current node and the node +node+
  #
  # source://ruby-graphviz//lib/graphviz/node.rb#106
  def >(node); end

  # Create an edge between the current node and the node +node+
  #
  # source://ruby-graphviz//lib/graphviz/node.rb#108
  def >>(node); end
...
class GraphViz::Types::ArrowType < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/arrow_type.rb#24
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/arrow_type.rb#27
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/arrow_type.rb#25
  def to_s; end
end
...
class GraphViz::Types::Color < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/color.rb#50
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/color.rb#53
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/color.rb#51
  def to_s; end
end
...
class GraphViz::Types::ColorList < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/color_list.rb#16
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/color_list.rb#19
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/color_list.rb#17
  def to_s; end
end
...
class GraphViz::Types::EscString < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/esc_string.rb#12
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/esc_string.rb#15
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/esc_string.rb#13
  def to_s; end
end
...
class GraphViz::Types::GvBool < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/gv_bool.rb#41
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/gv_bool.rb#44
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/gv_bool.rb#42
  def to_s; end
end
...
class GraphViz::Types::GvDouble < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/gv_double.rb#27
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/gv_double.rb#29
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/gv_double.rb#28
  def to_s; end
end
...
class GraphViz::Types::HtmlString < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/html_string.rb#13
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/html_string.rb#15
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/html_string.rb#14
  def to_s; end
end
...
class GraphViz::Types::LblString < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/lbl_string.rb#29
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/lbl_string.rb#31
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/lbl_string.rb#30
  def to_s; end
end
...
class GraphViz::Types::Rect < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/rect.rb#27
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/rect.rb#30
  def to_ruby; end

  # source://ruby-graphviz//lib/graphviz/types/rect.rb#28
  def to_s; end
end
...
class GraphViz::Types::SplineType < ::GraphViz::Types::Common
  ...
  # source://ruby-graphviz//lib/graphviz/types/spline_type.rb#47
  def to_gv; end

  # source://ruby-graphviz//lib/graphviz/types/spline_type.rb#48
  def to_s; end
